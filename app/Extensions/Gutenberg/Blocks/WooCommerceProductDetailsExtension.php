...
class WooCommerceProductDetailsExtension
{
    ...
    public function enqueue_block_editor_assets()
    {
        ...
        wp_enqueue_script(
            ...
            BLAZE_COMMERCE_PLUGIN_URL . 'assets/js/woocommerce-product-details-extension.js',
    ...
    public function enqueue_frontend_assets()
    {
        ...
        wp_enqueue_style(
            'woocommerce-product-details-extension',
            BLAZE_COMMERCE_PLUGIN_URL . 'assets/css/woocommerce-product-details-extension.css',
            array(),
            BLAZE_COMMERCE_VERSION
        );
    }
