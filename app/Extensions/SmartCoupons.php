...
class SmartCoupons {
	...
	public function __construct() {
		if ( function_exists( 'is_plugin_active' ) && is_plugin_active( 'wt-smart-coupon-pro/wt-smart-coupon-pro.php' ) ) {
		...
		register_graphql_object_type(
			...
			array(
				...
				'fields'      => array(
					...
					'variants'            => array(
						'type'        => array( 'list_of' => 'FreeProductItemVariants' ),
						'description' => __( 'Is the product a variation?', 'your-text-domain' ),
					),
					'variationId'         => array(
						'type'        => 'Int',
		...
		register_graphql_object_type(
			...
			array(
				...
				'fields'      => array(
					...
					'freeProducts' => array(
						'type'        => array( 'list_of' => 'FreeProductItems' ),
	...
	public function register_fields() {
		register_graphql_field(
			...
			'smartCoupons',
			array(
				'type'        => array( 'list_of' => 'SmartCoupons' ),
