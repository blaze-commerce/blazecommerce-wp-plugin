...
class HomePageSettings extends BaseSettings {
    ...
    public static function get_instance()
    {
        if (self::$instance === null) {
            self::$instance = new self( 'blaze_commerce_homepage_settings_options' );
        }
    ...
    public function register_hooks()
    {
        ...
        add_action( 'blaze_commerce_after_site_info_sync', array( $this, 'add_homepage_data' ), 10, 2 );
    }

    public function footer_callback()
    {
        require_once BLAZE_COMMERCE_PLUGIN_DIR . 'views/draggable-content.php';
    }
    ...
    public function default_draggable_data()
    {
        ...
        $homepage_layout = get_option('blaze_commerce_homepage_layout', '');
        ?>
