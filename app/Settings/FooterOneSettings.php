...
class FooterOneSettings extends BaseSettings {
    ...
    public static function get_instance()
    {
        if (self::$instance === null) {
            self::$instance = new self( 'blaze_commerce_footer_1_settings_options' );
        }
    ...
    public function settings_callback( $options )
    {
        ...
        if (is_array($footer_content_1)) {
            update_option('blaze_commerce_footer_1_content', $footer_content_1);
    ...
    public function register_hooks()
    {
        ...
        add_action( 'blaze_commerce_after_site_info_sync', array( $this, 'add_footer_one_data' ), 10, 2 );
    }
    ...
    public function default_draggable_data()
    {
        ...
        $footer_content = get_option('blaze_commerce_footer_1_content', '');
        ?>
    ...
    {
        $footer_content_1 = get_option('blaze_commerce_footer_1_content', '');
        TypesenseClient::get_instance()->site_info()->upsert([
            'id' => '1000006',
            'name' => 'footer_content_1',
            'value' => json_encode($footer_content_1),
