...
class SiteInfo extends BaseCollection {
	...
	public function prepare_batch_data() {
		...
		$category_setttings = apply_filters(
			'blazecommerce/settings/category',
			array(
		...
		$tax_settings = apply_filters(
			'blazecommerce/settings/tax',
			array(
		...
		$product_setttings = apply_filters(
			'blazecommerce/settings/product',
			array(
	...
	public function get_active_reviews_plugin() {
		...
		$filtered_plugins = array_filter(
			$active_plugins,
			function ( $plugin ) use ( $review_plugin_slugs ) {
		...
		$filtered_plugin_directories = array_map(
			function ( $plugin ) {
