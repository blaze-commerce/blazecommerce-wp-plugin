...
if ( !class_exists( 'Blaze_Wooless_Product_Page_Settings' ) ) {
    class Blaze_Wooless_Product_Page_Settings extends Blaze_Wooless_Base_Settings {
        ...
        {
            Blaze_Wooless_Typesense::get_instance()->site_info()->upsert([
                'id' => '1000001',
        ...
        {
            $options = Blaze_Wooless_Product_Page_Settings::get_instance()->get_option();
            $this->update_fields( $options );
        }
    }

    Blaze_Wooless_Product_Page_Settings::get_instance();
}
