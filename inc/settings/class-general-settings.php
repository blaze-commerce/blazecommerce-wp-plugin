...
if ( !class_exists( 'Blaze_Wooless_General_Settings' ) ) {
    class Blaze_Wooless_General_Settings extends Blaze_Wooless_Base_Settings {
        ...
        public function settings_callback( $options )
        {
            if ( isset( $options['api_key'] ) ) {
                ...
                $connection = Blaze_Wooless_Typesense::get_instance()->test_connection( $typesense_api_key, $store_id, $options['environment'] );
    ...
    Blaze_Wooless_General_Settings::get_instance();
}
